                ...
                ->addColumn('action', function($admin){
                    return '<div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="' . route('super_admins.admins.edit', $admin->id) . '" class="dropdown-item">
                                            <i class="fas fa-edit"></i>
                                                Edit
                                        </a>
                                    </li>
                                    <li>
                                        <form action="' . route('super_admins.admins.destroy', $admin->id) . '" method="post" class="ajax-delete">'
                                            . csrf_field() 
                                            . method_field('DELETE') 
