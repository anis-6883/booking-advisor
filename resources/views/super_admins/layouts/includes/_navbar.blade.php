    ...
    <div class="navbar-content">
       <form class="search-form">
          <div class="input-group">
             ...
             <input type="search" class="form-control" id="navbarForm" placeholder="Search here..." autocomplete="off">
          </div>
       </form>
       <ul class="navbar-nav">
             ...
             <div class="dropdown-menu p-0" aria-labelledby="messageDropdown">
                ...
                <div class="p-1">
                   <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                      <div class="me-3">
                         <img class="wd-30 ht-30 rounded-circle" src="{{ asset('public/default/profile.png') }}" alt="userr">
                      </div>
          ...
          <li class="nav-item dropdown">
             ...
             <img class="wd-30 ht-30 rounded-circle" src="{{ asset('public/default/profile.png') }}" alt="profile">
             </a>
             <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                   <div class="mb-3">
                      <img class="wd-80 ht-80 rounded-circle" src="{{ asset('public/default/profile.png') }}" alt="profile">
                   </div>
                ...
                <ul class="list-unstyled p-1">
                   ...
                   <li class="dropdown-item py-2">
                      <a href="{{ route('super_admins.logout') }}" class="text-body ms-0" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                        <i class="me-2 icon-md" data-feather="log-out"></i>
                        <span>Log Out</span>
                      </a>
                     <form id="logout-form" action="{{ route('super_admins.logout') }}" method="POST" class="d-none">
                        @csrf
                     </form>
                   </li>
                </ul>
