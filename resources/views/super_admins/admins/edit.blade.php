...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"> <a class="text-muted" href="{{ route('super_admins.admins.index') }}">Admin</a></li>
            ...
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('super_admins.admins.update', $admin->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @method('PUT')
