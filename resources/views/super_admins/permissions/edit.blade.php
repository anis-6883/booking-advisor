...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"> <a class="text-muted" href="{{ route('super_admin.permissions.index') }}">Permission</a></li>
            ...
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('super_admin.permissions.update', $permission->id) }}" method="POST" autocomplete="off">
                            @csrf
                            @method('PUT')
