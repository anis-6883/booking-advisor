...
@section('page_title', 'Add Room Facility')
    ...
    <div class="col-12 col-xl-12 stretch-card">
        <div class="row flex-grow-1">
            <div class="col-md-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h3 class="mb-3">Add New <span style="color: #0C32DC;">Facility</span></h3>
                        <hr>
                        <form action="{{ route('admin.room-facilities.store') }}" method="POST" autocomplete="off">
                            @csrf
                            @method('POST')
